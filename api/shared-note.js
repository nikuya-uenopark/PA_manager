  ...
  try {
    if (req.method === "GET") {
      ...
      if (latest && typeof latest.message === "string") {
        const prefix = "メモ更新\n";
        let body = latest.message.startsWith(prefix)
          ? latest.message.slice(prefix.length)
          : latest.message;
          ...
          if (firstNl !== -1) {
            ...
            try {
              ...
              if (meta && typeof meta === "object") {
                ...
                if (meta.opsFont) opsFont = meta.opsFont;
                if (meta.commFont) commFont = meta.commFont;
